```
# Effective bandwidth per model: 600 × 4 = 2,400 GB/s

# llama-3.1-8b: 16GB / 2,400 GB/s = 6.7ms per token (was 66.7ms)
# mixtral-8x7b: 87GB / 2,400 GB/s = 36.3ms per token (was 90.6ms) 
# llama-3.3-70b: 140GB / 2,400 GB/s = 58.3ms per token (was 72.9ms)
```
## About Me
